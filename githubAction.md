...
#### 自动同步Fork后的代码
  ...
  - 方案A - 强制远程分支覆盖自己的分支(**新手推荐使用**)
      ...
      1. 参考tg@wukongdada这篇教程 [保持自己github的forks自动和上游仓库同步的教程](https://github.com/l499477004/JD-scripts/blob/master/gitSync.md) ， 安装[pull插件](https://github.com/apps/pull) 并确认此项目已在pull插件的作用下（参考@twukongdada这篇教程文中1-d）
