...
!(async () => {
    await requireConfig();
    if (!cookieArr[0]) {
      $.msg($.name, '【提示】请先获取京东账号一cookie\n直接使用NobyDa的京东签到获取', 'https://bean.m.jd.com/bean/signIndex.actionbean/signIndex.action', {"open-url": "https://bean.m.jd.com/bean/signIndex.actionbean/signIndex.action"});
      return;
    }
